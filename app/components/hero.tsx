    ...
    <div className=" w-full h-screen ">
      ...
      <div className="absolute left-0 bottom-0 w-full flex flex-col justify-end h-screen pb-10 sm:pb-10 md:pb-10">
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col md:flex-row md:justify-between md:items-end gap-4 sm:gap-6 md:gap-8">
          <p className="font-body text-sm sm:text-lg md:text-2xl lg:text-2xl text-white max-w-xs sm:max-w-sm md:max-w-md lg:max-w-xl animate-slide-up leading-tight sm:leading-snug md:leading-normal">
          ...
          <button className="group flex items-center gap-2 animate-slide-up-delay w-fit flex-shrink-0">
            <span className="text-white text-sm sm:text-base md:text-lg lg:text-lg font-body underline decoration-white/50 decoration-1 underline-offset-4 group-hover:decoration-4 transition">
              EXPLORE 
            </span>
          </button>
        </div>
