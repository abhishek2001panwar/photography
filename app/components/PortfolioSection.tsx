    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-between w-full md:w-1/4 shrink-0 px-4 sm:px-6 md:px-10 py-8 sm:py-10 md:py-14 bg-[#e5ddd3] md:min-h-screen min-h-auto">
          ...
          <div>
            ...
            >
              ...
              <span className="text-[8px] sm:text-[9px] tracking-[0.35em] text-[#8b6840] uppercase">Services</span>
            </div>
          ...
          <div className={`fade-up ${inView ? 'show' : ''}`} style={{ transitionDelay: '200ms' }}>
            ...
            <p
              key={`loc-${active}`}
              className="font-body-custom text-[8px] sm:text-[7px] tracking-[0.18em] text-[#8b6840] mb-4 md:mb-6 caption-enter"
            >
              {cur.location} 
            </p>
        ...
        {/* ── Previous image (exit) ── */}
          ...
          {/* ── Bottom caption (visible on all sizes) ── */}
          <div className="absolute bottom-0 left-0 right-0 z-20 px-4 md:px-12 pb-6 md:pb-12">
            <div className="flex items-end justify-between">
              ...
              <div>
                <p
                  key={`cat-${active}`}
                  className="font-body-custom text-[4px] tracking-[0.35em] text-[#c9a96e] uppercase  caption-enter"
                >
                  {cur.location}
                </p>
                <h1
